...
export { getRooms, fetchRoomDetails ,bookHotel,getUserBookings,updateBookingStatus , addHotel, deleteHotel, updateHotel, getBookings,getRegisteredUsers, getCanceledBookings} ;
